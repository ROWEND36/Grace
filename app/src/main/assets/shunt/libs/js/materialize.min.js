  ...
  var Dropdown = function (_Component2) {
    ...
    _createClass(Dropdown, [{
      ...
      value: function _getDropdownPosition() {
        ...
        var idealHeight = this.options.height?Math.min(this.options.height,dropdownBRect.height):dropdownBRect.height;
...
;(function ($, anim) {
  ...
  var Tabs = function (_Component6) {
    ...
    _createClass(Tabs, [{
      ...
      value: function destroy() {
        this._removeEventHandlers();
        this._indicator && this._indicator.parentNode.removeChild(this._indicator);
      ...
      value: function _handleWindowResize() {
        ...
        if (this._indicator && this.tabWidth !== 0 && this.tabsWidth !== 0) {
